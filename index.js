...
async function connectToWA() {
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `KAVI-MD connected successful 🎗️`;
      let up1 = `HelloW KRP, I made bot successful 🎗️`;

      robin.sendMessage(ownerNumber + "@s.whatsapp.net", {
        image: {
          url: `https://i.postimg.cc/J7x6V20b/IMG-20250205-WA0002-2.jpg`,
        },
        caption: up,
      });
      robin.sendMessage("94762858448@s.whatsapp.net", {
        image: {
          url: `https://i.postimg.cc/J7x6V20b/IMG-20250205-WA0002-2.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️ KAVI-MD ❤️ started✅");
});
app.listen(port, () =>
